			    ...
			    <nav class="navbar navbar-default bootsnav navbar-fixed dark no-background">
			        ...
			        <div class="container">
			            ...
			            <div class="navbar-header">
			                ...
			                <a class="navbar-brand" href="index.html">Jagrati</a>
			            </div><!--/.navbar-header-->
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                ...
			                <li class=" smooth-menu active"></li>
			                    ...
			                    <li class="smooth-menu"><a href="#experience">trainings</a></li>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="single-about-txt">
								<h3>
									I am a Engineering student persuing B.tech degree from Techno India njr College.
									Along with this also preparing for MBA entrance
								</h3>
								<p>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="single-about-add-info">
											<h3>email</h3>
											<p>jagratigodake298@gmail.com</p>
										</div>
									</div>
									</div>
							...
							<div class="single-about-img">
								...
								<div class="about-list-icon">
									<ul>
										...
										<li>
											<a href="linkedin.com/in/jagratigodake">
												<i  class="fa fa-linkedin" aria-hidden="true"></i>
											</a>
										</li><!-- / li -->
										<li>
											<a href="instagram.com/jagrati_godake">
						...
						<div class="col-sm-4">
							<div class="single-horizontal-timeline">
								...
								<div class="timeline">
									<div class="timeline-content">
										<h4 class="title">
											Govt. Girls of Senior Secondary School
										</h4>
										<h5>Udaipur(Raj.), India</h5>
										<p class="description">
											Percentage: 80.60</p>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="single-skill-content">
									...
									<div class="barWrapper">
										<span class="progressText">Database</span>
										<div class="single-progress-txt">
											<div class="progress ">
										...
										<div class="row">
											<div class="col-md-5">
												<div class="experience-time text-right">
													<h2>2018 - Present</h2>
													<h3>preparing for Interviews and learning new softwares</h3>
												</div><!--/.experience-time-->
											</div><!--/.col-->
											<div class="col-md-offset-1 col-md-5">
												<div class="timeline">
													<div class="timeline-content">
														...
														<h5>Techno India njr Institute of Technology, Udaipur(Raj.)</h5>
														<p class="description">
														learning new softwares and computer languages along with this 
														Prearing for MBA entrance(Interviews) .
															</p>
													</div><!--/.timeline-content-->
												</div><!--/.timeline-->
											</div><!--/.col-->
											...
											<div class="col-md-5">
												<div class="timeline">
													<div class="timeline-content text-right">
														<h4 class="title">
															SQL,12C(1Z0-071),Udemy 

														</h4>
														<h5>Techno India njr Institute of Technology</h5>
														<p class="description">
														 learned to impliment the queries
															</p>
													</div><!--/.timeline-content-->
												</div><!--/.timeline-->
											</div><!--/.col-->
								...
								<li>
									<div class="single-timeline-box fix">
										<div class="row">
											<div class="col-md-5">
												<div class="experience-time text-right">
													<h2>June 2017-September 2017</h2>
													<h3>BEC Vantage - Cambridge, </h3>
												</div><!--/.experience-time-->
											</div><!--/.col-->
											<div class="col-md-offset-1 col-md-5">
												<div class="timeline">
													<div class="timeline-content">
														...
														<h5>Techno India NJR</h5>
														<p class="description">
														Cleared A business English Language Cetifcate</p>
													</div><!--/.timeline-content-->
												</div><!--/.timeline-->
											</div><!--/.col-->
										</div>
											...
											<div class="col-md-5">
												<div class="timeline">
													<div class="timeline-content text-right">
														...
														<h5>India(Raj.)</h5>
														<p class="description">
															Learned to work on Androis software which is used to develop 
															mobile appication.</p>
													</div><!--/.timeline-content-->
												</div><!--/.timeline-->
											</div><!--/.col-->
								...
								<li>
									<div class="single-timeline-box fix">
										<div class="row">
											<div class="col-md-5">
												<div class="experience-time text-right">
													<h2>December 2016 - January 2017</h2>
													<h3> C and Data Structure,Cranes </h3>
												</div><!--/.experience-time-->
											</div><!--/.col-->
											<div class="col-md-offset-1 col-md-5">
												<div class="timeline">
							...
							<div class="single-contact-box">
								...
								<div class="hm-foot-icon">
									<ul>
										...
										<li><a href="linkedin.com/in/jagratigodake"><i class="fa fa-linkedin"></i></a></li><!--/li-->
										<li><a href="instagram.com/jagrati_godake"><i class="fa fa-instagram"></i></a></li><!--/li-->
									</ul><!--/ul-->
								</div><!--/.hm-foot-icon-->
							</div><!--/.single-contact-box-->
						</div><!--/.col-->
		...
		<footer id="footer-copyright" class="footer-copyright">
			<div class="container">
				<div class="hm-footer-copyright text-center">
					<p>
						&copy; copyright jagratigodake. design and developed by <a href="https://www.themesine.com/">themesine</a>
					</p><!--/p-->
				</div><!--/.text-center-->
			</div><!--/.container-->
